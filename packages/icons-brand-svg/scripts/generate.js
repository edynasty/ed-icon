...
`;
  ...
  console.log(`生成品牌图标文件: ${iconName}.ts`);
...
function generateAllIcons() {
  ...
  // 生成导出文件
  const exportContent = `// 自动生成的品牌图标导出文件
${iconData
...
`;
  ...
  console.log("生成品牌图标导出文件: index.ts");
  console.log(`总共生成了 ${iconData.length} 个品牌图标定义文件`);
}
